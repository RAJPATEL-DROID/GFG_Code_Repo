...
<p>&nbsp;</p>
<pre class="reportedIssues_issueDesc__CxR6S" style="box-sizing: inherit; font-family: inherit; font-size: 14px; min-height: 50%; word-break: break-all; white-space: break-spaces; color: rgba(0, 0, 0, 0.87); background-color: rgb(255, 255, 255); position: relative;"><span style="font-size: 14pt;"><strong>Note</strong>: The price from city A to B may be different From price from city B to A. </span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
