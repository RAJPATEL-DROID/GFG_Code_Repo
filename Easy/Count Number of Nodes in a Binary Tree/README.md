...
<pre style="position: relative;"><span style="font-size:18px">Input: </span>
...
<span style="font-size:18px">There are a total of 6 nodes in the given tree.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
